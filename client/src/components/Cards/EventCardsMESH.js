    ...
    return (
      <Card sx={{ width: 400, height: 450, borderRadius: 3, overflow: 'hidden', position: 'relative', border: '1px solid #ccc', boxShadow: 3, marginY: 2, display: 'flex', flexDirection: 'column'}}>
        ...
        >
          ...
          <IconButton>
            <CalendarMonthIcon sx={{ color: '#344C42' }}/>
          </IconButton>
        </Box>
        ...
        {/* Content */}
        <CardContent sx={{ backgroundColor: '#CEE9DC', flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent:"space-between" }}>
